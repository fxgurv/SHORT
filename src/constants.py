...
HERCAI_IMAGE_MODELS = ["v1", "v2", "v3 (DALL-E)", "lexica", "simurg", "animefy", "raava", "shonin"]
G4F_IMAGE_MODELS = ["sdxl", "sd-3", "playground-v2.5", "flux", "flux-pro", "flux-realism", "flux-anime", "flux-3d", "flux-disney", "flux-pixel", "flux-4o", "any-dark"]
...
GEMINI_MODELS = ["gemini", "gemini-pro", "gemini-flash"]
CLAUDE_MODELS = ["claude-2.1", "claude-3-opus", "claude-3-sonnet", "claude-3-haiku", "claude-3.5-sonnet"]
OPENAI_MODELS = ["gpt-3", "gpt-3.5-turbo", "gpt-4o", "gpt-4o-mini", "gpt-4", "gpt-4-turbo"]
HERCAI_TEXT_MODELS = ["V3", "V3-32k", "Turbo", "Turbo-16k", "Gemini", "LLama3-70b", "LLama3-8b", "Mixtral-8x7b", "Gemma-7b", "Gemma2-9b"]
G4F_TEXT_MODELS = ["gpt-3", "gpt-3.5-turbo", "gpt-4o", "gpt-4o-mini", "gpt-4", "gpt-4-turbo", "meta-ai", "llama-2-7b", "llama-3-8b", "llama-3.1-8b", "llama-3.1-70b", "llama-3.1-405b", "llama-3.2-1b", "llama-3.2-11b", "mixtral-8x7b", "mistral-nemo", "hermes-3", "phi-2", "phi-3.5-mini", "gemini", "gemini-pro", "gemini-flash", "gemma-2b", "claude-2.1", "claude-3-opus", "claude-3-sonnet", "claude-3-haiku", "claude-3.5-sonnet", "reka-core", "blackboxai", "blackboxai-pro", "command-r+", "gigachat", "qwen-1.5-7b", "qwen-2-72b", "solar-pro", "pi", "llava-13b", "wizardlm-2-8x22b", "openchat-3.5", "grok-2", "grok-2-mini", "grok-beta", "sonar-online", "sonar-chat", "german-7b", "nemotron-70b"]
